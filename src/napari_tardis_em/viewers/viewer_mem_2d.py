...
class TardisWidget(QWidget):
    ...
    def __init__(self, viewer_mem_2d: Viewer):
        ...
        self.patch_size.setCurrentIndex(6)
        ...
        #############################
        label_5 = QLabel("Optional Membrane Filters          ")
        label_5.setStyleSheet(border_style("orange"))

        self.connect_membranes = QLineEdit("1000")
        self.connect_membranes.setValidator(QIntValidator(0, 10000))
        self.connect_membranes.setToolTip(
            "To address the issue where membrane are mistakenly \n"
        ...
        self.connect_membranes.textChanged.connect(self.update_dist_graph)
        ...
        self.connect_cylinder.setToolTip(
            "To minimize false positives when linking membranes, we limit \n"
        ...
        layout.addRow("-- Membrane Filters ---", label_5)
    ...
    def update_versions(self):
        ...
        versions = get_all_version_aws(self.cnn_type.currentText(), "32", "membrane_2d")
    ...
    def predict_instance(self):
        ...
        if not self.output_formats.endswith("None"):
            if self.predictor.dist is None:
                ...
                self.predictor.build_NN("Membrane2D")
