...
class TardisWidget(QWidget):
    ...
    def __init__(self, viewer_actin_3d: Viewer):
        ...
        ###########################
        label_5 = QLabel("Optional Actin Filters             ")
        ...
        self.filter_by_length.setToolTip(
            "Filtering parameters for actin, defining maximum actin \n"
        ...
        self.connect_splines.setToolTip(
            "To address the issue where actin are mistakenly \n"
        ...
        self.connect_cylinder.setToolTip(
            "To minimize false positives when linking actin, we limit \n"
    ...
    def show_command(self):
        ...
        cs = (
            ...
            else f"-cs {int(self.connect_splines.text())} "
        )
        cc = (
            ""
